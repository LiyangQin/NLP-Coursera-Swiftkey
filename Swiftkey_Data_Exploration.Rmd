...
The data is from a corpus called HC Corpora (www.corpora.heliohost.org). See the readme file at [http://www.corpora.heliohost.org/aboutcorpus.html](http://www.corpora.heliohost.org/aboutcorpus.html) for details on the corpora available. The data came from a series of text documents in severallanguages from blogs, news and twitter content and came from [Swiftkey](https://swiftkey.com).
...
### 0.1 Key Findings
 *  Date set is huge and it must be sample and preprocess to be handle by
 an online app
